...
INSERT INTO hospitals (hospital_id ,hospital_name ,address,phone_number )
VALUES
...
INSERT INTO doctors (doctor_id, doctor_name, specialty, hospital_id, email)
VALUES
...
INSERT INTO patients (patient_id, patient_name, dob, address, phone_number )
VALUES
...
-- Inserting Data into depatments Table

INSERT INTO departments (department_id, hospital_id, department_name)
VALUES
(1, 1, 'Cardiology'),
(2, 1, 'Radiology'),
(3, 1, 'Oncology'),
...
INSERT INTO medications (medication_id, Medication_name, medicine_description)
VALUES
...
-- Inserting Data into Prescribtion Table
